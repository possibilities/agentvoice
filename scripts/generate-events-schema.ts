...
export function buildEventsSchema() {
  return {
    ...
    description:
      "Protocol 2 fleet NDJSON event contract: lifecycle/voice events and typed conversation observation, with live snapshots, bounded replay and scoped native history pages. Lifecycle and conversation snapshots have separate watermarks; voice events are never replayed. See docs/events.md and docs/conversations.md.",
  };
}
if (import.meta.main) {

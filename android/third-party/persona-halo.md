...
- Upstream repository copyright: Copyright 2023 Vercel, Inc.; Apache License 2.0.
...
The original AI Elements and Rive license notices and the Apache 2.0 license
text are included in `app/src/main/assets/notices` and packaged in both APKs.

...
class PersonaPreviewTest {
    ...
    @Test fun profileMigrationAndAtomicSaveKeepAllThreeSizes() {
        ...
        try {
            ...
            assertEquals(24, JSONObject(fixture.readText()).getInt("version"))
            ...
            val v5 = JSONObject(v4).put("version", 5).put("halo", halo.json()).withoutThinkingWingspan().toString()
    ...
    @Test fun adbPreviewBridgeAuthenticatesBoundsFramesAndReleasesItsSocket() {
        ...
        try {
            ...
            connect().use { socket ->
                ...
                val response = JSONObject(readFrame(socket.inputStream, 65536)!!)
                ...
                assertTrue(JSONObject(readFrame(socket.inputStream, 65536)!!).has("error"))
                ...
                val saved = JSONObject(readFrame(socket.inputStream, 65536)!!)
            ...
            connect().use { socket ->
                ...
                val returned = JSONObject(readFrame(socket.inputStream, 65536)!!).getJSONObject("state")

...
September 13, 2026 lifecycle update: [ADR 0053](0053-retain-workspace-session-across-frontend-detach.md)
supersedes the frontend-scoped call lifetime above. The mailbox and wake-up
machinery now survive frontend detach and clear on explicit server shutdown or
`new_session`; all delivery and ambiguity rules remain.

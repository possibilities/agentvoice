...
| [0038: Thread mailbox wake-ups](0038-thread-mailbox-wakeups.md) | Superseded | [0080](0080-direct-child-completion-delivery.md) removed the mailbox; [0103](0103-retire-synthetic-subagent-lifecycle-steering.md) later removed its replacement completion output. |
...
| [0049: Add a worker role with bounded assignment ownership](0049-worker-role.md) | Partially superseded | [0108](0108-use-one-agentstart-default-role.md) retires the separate worker directory; parent-or-human return ownership and native worker responsibility remain. |
...
| [0051: AgentStart owns manager and worker roles](0051-agentstart-owns-working-roles.md) | Superseded for naming and roster | [0108](0108-use-one-agentstart-default-role.md) restores one AgentStart-owned role named `default`; generic external-role consumption remains. |
...
| [0059: Clarify mailbox and conversation-hold guidance](0059-clarify-mailbox-and-conversation-hold-guidance.md) | Partially superseded | [0080](0080-direct-child-completion-delivery.md) removed its mailbox behavior and [0103](0103-retire-synthetic-subagent-lifecycle-steering.md) retired the replacement lifecycle steering; the conversational-hold conclusion remains. |
...
- [0080: Deliver each direct-child completion immediately](0080-direct-child-completion-delivery.md) — superseded by [0103](0103-retire-synthetic-subagent-lifecycle-steering.md); historical native tool outputs remain in history.
...
- [0092: Defer direct-child delivery during human speech](0092-defer-direct-child-delivery-during-human-speech.md) — superseded first by [0094](0094-restore-immediate-direct-child-delivery.md) and finally by [0103](0103-retire-synthetic-subagent-lifecycle-steering.md).
...
- [0094: Restore immediate direct-child completion delivery](0094-restore-immediate-direct-child-delivery.md) — superseded by [0103](0103-retire-synthetic-subagent-lifecycle-steering.md), which removes the lifecycle-derived `turn/start` path.
...
- [0108: Use one AgentStart default role](0108-use-one-agentstart-default-role.md) — accepted; AgentStart publishes only `default`, native workers keep parent-return responsibility without a separate role directory, and generic AgentVoice role loading remains unchanged.

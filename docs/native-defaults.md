...
9. AgentVoice does not restore saved speech into realtime input
   ([ADR 0074](adr/0074-fail-closed-voice-history.md)); explicit raw initialItems owns the slot. `initialItems` is realtime v3 only, capped at 128 items and 8,192 estimated

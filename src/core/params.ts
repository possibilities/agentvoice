...
export function realtimeParams(
  ...
  // Preserve Codex's native resolution when no policy was selected. Explicit
  // configuration and the raw passthrough below still intentionally own this
  // field, including raw null.
